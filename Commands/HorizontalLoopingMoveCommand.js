class HorizontalLoopingMoveCommand extends BaseMoveCommand {
    ...
    getClone() {
        return new HorizontalLoopingMoveCommand(this.gameObject, this.initialVector, this.radius, this.nbLoop);
    }
