class Player1ShipGameObject extends PlayerShipGameObject {
    constructor(initialPosition) {
        super(Services.get(Services.ASSET).getImage("Images/player1.png"), new Vec2(64), initialPosition)
...
class Player1ShipMiniatureGameObject extends AnimatedSprite {
    ...
    constructor() {        
        let miniature = ImageHandler.zoomImage(Services.get(Services.ASSET).getImage("Images/player1.png"), new Vec2(1));
