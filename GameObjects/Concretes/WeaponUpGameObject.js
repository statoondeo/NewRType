class WeaponUpGameObject extends AnimatedSprite {
    constructor() {
        super(Services.get(Services.ASSET).get("Images/powerup.png"), new Vec2(64));
...
class MiniWeaponUpGameObject extends AnimatedSprite {
    constructor() {
        super(ImageHandler.zoomImage(Services.get(Services.ASSET).get("Images/powerup.png"), new Vec2(0.5)), new Vec2(32))
        this.layer = 1;
