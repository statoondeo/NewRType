class WobblerGameObject extends EnemyShipGameObject {
    constructor(playerShip) {
        super(Services.get(Services.ASSET).get("Images/wobbler.png"), new Vec2(64), 600, 200, Services.get(Services.ASSET).get("Images/wobbler2.png"));
...
class WobblerCurve extends BezierCurve {
    constructor() {
        ...
        let pt1 = new Vec2(-screen.width / 4, screen.height - WobblerGameObject.size.y);
