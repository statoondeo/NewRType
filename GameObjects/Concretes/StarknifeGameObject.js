class StarknifeGameObject extends EnemyShipGameObject {
    constructor() {
        ...
        this.fireCommand = new AsapFireCommand(new FireRatedFireCommand(this, new RedBulletGameObject(this.partition, new Vec2(-1, 0), Math.random() * 300 + 300), new Vec2(), Math.random() * 1.5 + 1.5, new SoundPool(Services.get(Services.ASSET).get("Sounds/laser5.mp3"), 15)));
