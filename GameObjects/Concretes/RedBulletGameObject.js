class RedBulletGameObject extends BulletGameObject {
    constructor(partition, direction = new Vec2()) {
        ...
        super(Services.get(Services.ASSET).getImage("Images/redbullet.png"), new Vec2(32), partition, direction, 350, 100);
        this.dieCommand.addCommand(new PopCommand(this, new RedExplosionGameObject()));
        this.layer = 0.99;
        this.sound = Services.get(Services.ASSET).getSound("sounds/laser1.mp3");
    }
